# -*- encoding: utf-8 -*-
# stub: minitest-rails 0.9.2.20131029131423 ruby lib

Gem::Specification.new do |s|
  s.name = "minitest-rails"
  s.version = "0.9.2.20131029131423"
