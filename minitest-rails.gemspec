# -*- encoding: utf-8 -*-
# stub: minitest-rails 6.0.0.20190505141231 ruby lib

Gem::Specification.new do |s|
  s.name = "minitest-rails".freeze
  s.version = "6.0.0.20190505141231"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<railties>.freeze, ["~> 6.0.0.beta1"])
      ...
      s.add_dependency(%q<railties>.freeze, ["~> 6.0.0.beta1"])
