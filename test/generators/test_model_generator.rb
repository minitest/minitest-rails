...
class TestModelGenerator < GeneratorTest
  ...
  def test_model_generator
    ...
    assert_match /create  test\/models\/user_test.rb/m, output
  ...
  def test_namespaced_model_generator
    ...
    assert_match /create  test\/models\/admin\/user_test.rb/m, output
  ...
  def test_module_namespaced_model_generator
    ...
    output = run_generator %w(user --no-spec)
    assert_match /create  test\/models\/test_app\/user_test.rb/m, output
  ...
  def test_model_generator_fixture
    ...
    assert_match /create  test\/fixtures\/users.yml/m, output
  ...
  def test_namespaced_model_generator_fixture
    ...
    assert_match /create  test\/fixtures\/admin\/users.yml/m, output
  ...
  def test_model_generator_skip_fixture
    ...
    refute_match /create  test\/fixtures\/users.yml/m, output
